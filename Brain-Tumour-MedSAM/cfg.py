...
def parse_args():    
    ...
    parser.add_argument('-w', type=int, default=6, help='number of workers for dataloader')
    ...
    parser.add_argument('-dataset', type=str, default='brats', help='dataset name')
    parser.add_argument('-sam_ckpt', default=None , help='sam checkpoint address')
    parser.add_argument('-thd', type=bool, default=False , help='3d or not')
    parser.add_argument('-chunk', type=int, default=78 , help='crop volume depth')
