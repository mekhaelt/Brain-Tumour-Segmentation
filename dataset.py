...
#     class DummyArgs:
#         dataset = 'brats'         # or 'brats_2020' depending on your folder name
#         image_size = 240
#         out_size = 240
#         four_chan = True          # Set to False if testing single-modality input
#         mri = 't1'                # Used only if four_chan is False

#     args = DummyArgs()

#     # Update this path to point to your BraTS-style dataset directory
#     data_path = 'C:/Users/mekha/Desktop/Projects/med-sam-brain/data'  # <-- CHANGE THIS

#     # Create dataset and dataloader
#     dataset = Brats(args, data_path=data_path, mode='Training', prompt='click', plane=False)
...
#     print(f"Click label: {sample['p_label']}")
#     print(f"Patient ID: {sample['image_meta_dict']['filename_or_obj']}")
